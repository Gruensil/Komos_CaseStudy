...
var AccountListFilter = (function () {
    function AccountListFilter() {
    }
    AccountListFilter.prototype.transform = function (items, filterBy) {
    ...
    AccountListFilter = __decorate([
        core_1.Pipe({ name: 'accountListFilter' }), 
        __metadata('design:paramtypes', [])
    ], AccountListFilter);
    return AccountListFilter;
}());
exports.AccountListFilter = AccountListFilter;
//# sourceMappingURL=accountList.pipe.js.map